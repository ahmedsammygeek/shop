						...
						<div class="form-group row">
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<textarea name="content[ar]" id="editor" class="form-control @error('content.ar') is-invalid @enderror" rows="3" required="required">{{ $page->getTranslation('content' , 'ar') }}</textarea>
									@error('content.ar')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
							...
							<div class="col-md-12">
								<div  class='mb-2' >
									...
									<textarea name="content[en]" id="editor1" class="form-control @error('content.en') is-invalid @enderror" rows="3" required="required">{{ $page->getTranslation('content' , 'en') }}</textarea>
									@error('content.en')
									<p  class='text-danger' >  {{ $message }} </p>
									@enderror
								</div>
